...
namespace Microsoft.Windows.Controls
{
    ...
    /// </summary>
    public class DataGridPactComboBoxColumn : DataGridColumn
    {
        #region Constructors

        static DataGridPactComboBoxColumn()
        {
            SortMemberPathProperty.OverrideMetadata(typeof(DataGridPactComboBoxColumn), new FrameworkPropertyMetadata(null, OnCoerceSortMemberPath));
        }
        ...
        internal class TextBlockPactComboBox : PactComboBox
        {
            static TextBlockPactComboBox()
            {
                DefaultStyleKeyProperty.OverrideMetadata(typeof(TextBlockPactComboBox), new FrameworkPropertyMetadata(typeof(TextBlockPactComboBox)));
                KeyboardNavigation.IsTabStopProperty.OverrideMetadata(typeof(TextBlockPactComboBox), new FrameworkPropertyMetadata(false));
                DataContextProperty.OverrideMetadata(typeof(TextBlockPactComboBox), new FrameworkPropertyMetadata(OnDataContextPropertyChanged));
            }
        ...
        /// <summary>
        ///     The binding that will be applied to the SelectedValue property of the PactComboBox.  This works in conjunction with SelectedValuePath  
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///     The binding that will be applied to the SelectedItem property of the PactComboBoxValue.
        /// </summary>
        /// <remarks>
        ///     This isn't a DP because if it were getting the value would evaluate the binding.
        /// </remarks>
        ...
        /// <summary>
        ///     The binding that will be applied to the Text property of the PactComboBoxValue.
        /// </summary>
        /// <remarks>
        ///     This isn't a DP because if it were getting the value would evaluate the binding.
        /// </remarks>
        ...
        public static readonly DependencyProperty ElementStyleProperty =
            DataGridBoundColumn.ElementStyleProperty.AddOwner(typeof(DataGridPactComboBoxColumn));
        ...
        public static readonly DependencyProperty EditingElementStyleProperty =
            DataGridBoundColumn.EditingElementStyleProperty.AddOwner(typeof(DataGridPactComboBoxColumn));
        ...
        #region PactComboBox Column Properties

        /// <summary>
        ///     The PactComboBox will attach to this ItemsSource.
        /// </summary>
        ...
        public static readonly DependencyProperty ItemsSourceProperty =
            PactComboBox.ItemsSourceProperty.AddOwner(typeof(DataGridPactComboBoxColumn), new FrameworkPropertyMetadata(null, DataGridColumn.NotifyPropertyChangeForRefreshContent));
        ...
        public static readonly DependencyProperty DisplayMemberPathProperty =
                PactComboBox.DisplayMemberPathProperty.AddOwner(typeof(DataGridPactComboBoxColumn), new FrameworkPropertyMetadata(string.Empty, DataGridColumn.NotifyPropertyChangeForRefreshContent));
        ...
        public static readonly DependencyProperty SelectedValuePathProperty =
                PactComboBox.SelectedValuePathProperty.AddOwner(typeof(DataGridPactComboBoxColumn), new FrameworkPropertyMetadata(string.Empty, DataGridColumn.NotifyPropertyChangeForRefreshContent));
        ...
        protected override bool CommitCellEdit(FrameworkElement editingElement)
        {
            ...
            if (PactComboBox != null)
            {
                DataGridHelper.UpdateSource(PactComboBox, PactComboBox.SelectedValueProperty);
                DataGridHelper.UpdateSource(PactComboBox, PactComboBox.SelectedItemProperty);
                DataGridHelper.UpdateSource(PactComboBox, PactComboBox.TextProperty);
                return !Validation.GetHasError(PactComboBox);
            }
        ...
        protected override void CancelCellEdit(FrameworkElement editingElement, object uneditedValue)
        {
            ...
            if (PactComboBox != null)
            {
                DataGridHelper.UpdateTarget(PactComboBox, PactComboBox.SelectedValueProperty);
                DataGridHelper.UpdateTarget(PactComboBox, PactComboBox.SelectedItemProperty);
                DataGridHelper.UpdateTarget(PactComboBox, PactComboBox.TextProperty);
            }
        }

        internal override void OnInput(InputEventArgs e)
        {
            if (IsPactComboBoxOpeningInputEvent(e))
            {
                BeginEdit(e);
            }
        }

        private static bool IsPactComboBoxOpeningInputEvent(RoutedEventArgs e)
        {
