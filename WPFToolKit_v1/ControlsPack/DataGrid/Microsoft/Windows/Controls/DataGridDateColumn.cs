...
namespace Microsoft.Windows.Controls
{
    ...
    public class DataGridDateColumn : DataGridBoundColumn
    {
        ...
        protected override FrameworkElement GenerateElement(DataGridCell cell, object dataItem)
        {
            ...
            DatePicker textBlock = new DatePicker();
            textBlock.Padding = new Thickness(0);
            
            textBlock.IsButtonDynamicShow = true;
            textBlock.HideTextBoxBackground = true;
            textBlock.BorderBrush = null;
            textBlock.Height = 15;
            SyncProperties(textBlock);

          //  ApplyStyle(/* isEditing = */ false, /* defaultToElementStyle = */ false, textBlock);
            ApplyBinding(textBlock, DatePicker.TextProperty);
            return textBlock;
        }
        ...
        {
            DatePicker textBox = new DatePicker();
            textBox.CustomFormat = "dd MMM yyyy";
            textBox.SelectedDateFormat = DatePickerFormat.Custom;
            SyncProperties(textBox);

            //ApplyStyle(/* isEditing = */ true, /* defaultToElementStyle = */ false, textBox);
            ApplyBinding(textBox, DatePicker.TextProperty);
